...
User-scoped skills install under `$HOME/.claude/skills` (default: `~/.claude/skills`).
...
Script path:
- `$JUPYTER_NOTEBOOK_CLI` (installed default: `$HOME/.claude/skills/jupyter-notebook/scripts/new_notebook.py`)
